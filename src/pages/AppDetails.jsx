...
const currentUser = {
  name: "John Doe", // Replace this dynamically after login
};
...
const AppDetails = () => {
  ...
  if (!app) {
    return (
      <p className="text-center mt-10 text-gray-400">App details not found.</p>
    );
  }
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        <div className="flex-1">
          ...
          <button
            ...
            className="mt-2 px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg transition"
          >
